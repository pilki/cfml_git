...
Lemma set_head_spec : forall a,
  Spec ML.set_head (x:a) (l:mlist a) |R>> forall (x':a) (t:mlist a),
...
Lemma set_tail_spec : forall a,
  Spec ML.set_tail (t:mlist a) (l:mlist a) |R>> forall (x:a) (t':mlist a),
    R (l ~> Ref Id (x,t)) (# l ~> Ref Id (x,t)).
Proof. 
  xcf. intros. xapps. xmatch. xapp. hsimpl.
Qed.
...
Implicit Arguments focus_mscons [ ].
...
Lemma mappend_spec : forall a,
  Spec mappend (l1:mlist a) (l2:mlist a) |R>> forall A (T:A->a->hprop) (L1 L2:list A),
     R (l1 ~> MList T L1 \* l2 ~> MList T L2) (\= (length L : int)).
Proof.
