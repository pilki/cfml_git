...
let coqtops_of_pure_cftops cfts =
   list_concat_map coqtops_of_pure_cftop cfts
...
let coqtops_of_imp_cftops cfts =
   list_concat_map coqtops_of_imp_cftop cfts
